...
class dp_master(models.Model):
    ...
    username = models.CharField(max_length=250, unique=True, help_text='Required')
...
class dp_vehicle_model(models.Model):
    dp = models.ForeignKey(dp_master)
...
class Dp_order_model(models.Model):
    dp = models.ForeignKey(dp_master)
    status_order = models.CharField(max_length=120, choices = STATUS_CHOICES, default='started')
